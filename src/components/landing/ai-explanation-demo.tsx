...
const fallbackDemoQuestion = {
  id: 1,
  level: "N3",
  type: "Vocabulary", // Will be replaced by translation
...
export const AIExplanationDemo = ({ translations }: AIExplanationDemoProps) => {
  ...
  return (
    <section id="ai-demo-section" className="relative bg-background py-12 md:py-20 lg:py-24">
      <div className="app-container app-section">
        <div className="app-content px-4">
          ...
          >
            <div className="bg-background rounded-2xl border border-border/50 p-4 md:p-8 shadow-lg">
              {/* Question Header */}
              <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
                <div className="px-2 md:px-3 py-1 bg-muted/20 rounded-lg text-xs md:text-sm font-medium text-foreground">
                  {demoQuestion.level}
                </div>
                <div className="px-2 md:px-3 py-1 bg-muted/20 rounded-lg text-xs md:text-sm font-medium text-foreground">
                  {t('aiDemo.question.type')}
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                {selectedOption && !showExplanation && (
                  <motion.button
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-foreground text-background rounded-xl font-medium hover:bg-foreground/90 hover:text-background transition-all duration-200"
                  >
                ...
                {showExplanation && (
                  <motion.button
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    onClick={resetDemo}
                    className="px-6 py-3 border border-border rounded-xl font-medium text-foreground hover-muted transition-all duration-200"
                  >
