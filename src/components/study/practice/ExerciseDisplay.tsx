...
// Component to safely render HTML from a string
const RenderHTML = ({ content, as: Component = 'div', className = '' }: { content: string, as?: 'div' | 'span', className?: string }) => {
  if (!content) return null;
  // Using dangerouslySetInnerHTML to render tags like <u>. This is acceptable here
  // as the content is generated by our controlled AI prompts.
    ...
    <div className="space-y-4">
      ...
      <div className="bg-background rounded-2xl p-6 space-y-6">
        <div className="space-y-4">
          ...
          {question.type === 'reading_comprehension' && question.passage && (
            <div className="space-y-4">
              <div className="bg-muted/20 rounded-lg p-4 border border-border/20">
                ...
                <RenderHTML content={question.passage} as="div" className="text-base leading-relaxed whitespace-pre-wrap" />
              </div>
          ...
          {/* Question Text */}
          <RenderHTML content={question.question} as="div" className="text-lg font-medium" />
            ...
            {question.options.map((option, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <RenderHTML content={option} as="span" />
                  </Label>
                  {showResult && (
          ...
          {showExplanation && userAnswer && question && (
            ...
            >
              <div
                ...
                role="status"
              >
                {userAnswer.isCorrect ? `✅ ${t('study.practice.exercise.feedback.correct')}` : `❌ ${t('study.practice.exercise.feedback.incorrect')}`}
              </div>
