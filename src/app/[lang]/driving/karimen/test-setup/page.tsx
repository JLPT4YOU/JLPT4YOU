...
interface KarimenTestSetupPageProps {
  params: Promise<{
    lang: string
  }>
}

export default function KarimenTestSetupPage({ params }: KarimenTestSetupPageProps) {
  ...
  const handleStartTest = (
    ...
    router.push(`/${language}/driving/karimen/test?${searchParams.toString()}`)
  }
