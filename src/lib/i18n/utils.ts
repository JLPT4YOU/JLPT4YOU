/**
 * Consolidated i18n Utilities for JLPT4You
 * Merged from i18n-utils.ts and optimized for performance
 */

import { Language, SUPPORTED_LANGUAGES, DEFAULT_LANGUAGE } from './types'

/**
 * Cached regex for better performance - compile once
 */
 ...
 * Replaces multiple scattered functions
 */
...
/**
 * Path management utilities - consolidated class
 */
