...
CREATE INDEX idx_redeem_codes_created_by ON public.redeem_codes(created_by);
CREATE INDEX idx_redeem_codes_redeemed_by ON public.redeem_codes(redeemed_by);

-- Create redeem_history table for tracking
...
CREATE INDEX idx_redeem_history_user_id ON public.redeem_history(user_id);
CREATE INDEX idx_redeem_history_code_id ON public.redeem_history(code_id);
...
-- Users can only read active codes (for validation)
