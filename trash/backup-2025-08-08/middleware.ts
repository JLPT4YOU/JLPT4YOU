...
export async function middleware(request: NextRequest) {
  ...
  const publicRoutes = ['/auth', '/', '/debug', '/api/health', '/favicon.ico', '/_next', '/landing']
...
export const config = {
  matcher: [
    ...
    // Exclude: api, _next/static, _next/image, favicon.ico, public, auth, and landing routes
    '/((?!api|_next/static|_next/image|favicon.ico|public|auth|.*\/landing).*)',
  ],
}
