              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 place-items-center w-max">
                ...
                >
                  <article className="bg-muted/10 rounded-2xl p-6 md:p-8 text-center transition-all duration-200 hover:bg-muted/30 border border-border/20 group-hover:scale-105">
                    ...
                    <h2 className="font-semibold text-foreground mb-2 text-xl">{t('vocabulary.title') || 'Từ vựng'}</h2>
                    <p className="text-muted-foreground text-sm">{t('vocabulary.description') || 'Học từ vựng theo cấp độ'}</p>
                  </article>
                </Link>
                ...
                >
                  <article className="bg-muted/10 rounded-2xl p-6 md:p-8 text-center transition-all duration-200 hover:bg-muted/30 border border-border/20 group-hover:scale-105">
                    ...
                    <h2 className="font-semibold text-foreground mb-2 text-xl">{t('grammar.title') || 'Ngữ pháp'}</h2>
                    <p className="text-muted-foreground text-sm">{t('grammar.description') || 'Học ngữ pháp theo cấp độ'}</p>
                  </article>
                </Link>
              </div>
            </main>
